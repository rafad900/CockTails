...
import com.rememberthekey.cocktail.network.byRandom.RandomCockTailSearchAsyncTask;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRestart() {
        super.onRestart();
        turn_on_buttons();
        randomActivity.setText(R.string.main_option4);
    }

    private void turn_off_buttons() {
        nameActivity.setEnabled(false);
        ingredientActivity.setEnabled(false);
        nonAlcoholicActivity.setEnabled(false);
        randomActivity.setEnabled(false);
    }

    private void turn_on_buttons() {
        nameActivity.setEnabled(true);
        ingredientActivity.setEnabled(true);
        nonAlcoholicActivity.setEnabled(true);
        randomActivity.setEnabled(true);
    }
}
